        ...
        return index % 2 === 0 ? (
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <i
                    className={`fa-solid fa-caret-down hidden md:block absolute bottom-[-0.9em] left-[50%] text-lg text-[${Project_Color}]`}
                    aria-hidden="true"
                  ></i>
                </div>
                <div
                ...
                >
                  <div className="rounded-lg overflow-hidden h-[30vh] bg-white dark:bg-gray-800 z-[9999]">
                    <img
                      ...
                      className="dark:hidden h-[30vh] w-full rounded-lg z-[9999]"
                      alt=""
                      loading="lazy"
                    />
                  </div>
            ...
            <div className="basis-full md:basis-1/2  flex flex-col justify-center  px-4 md:px-24  h-[50vh]  py-8 md:py-0 ">
              <h2
                className={`text-3xl font-family-['Nunito', sans-serif ] font-bold text-[${Project_Color}] mb-0 md:mb-1`}
                data-aos="fade-left"
                data-aos-offset="0"
                data-aos-delay="50"
                data-aos-duration="1200"
              ...
              <h6
                className={`text-xl font-family-['Nunito', sans-serif ] font-medium text-[${Project_Color}] mb-3 md:mb-2`}
                data-aos="fade-left"
                data-aos-offset="0"
                data-aos-delay="50"
                data-aos-duration="1200"
              ...
              >
                ...
                {Project_tag.split(",").map((tag, index) => {
                  return (
                    <span
                      className={`rounded-full border py-1 px-3 border-[${Project_Color}] text-[${Project_Color}]  font-extrabold`}
                      key={index}
                    >
                      {tag}
                    </span>
            ...
            <div className="basis-full md:basis-1/2 md:border-r-2 md:border-[#1788ae]  flex flex-col justify-center  px-4 md:px-24  h-[50vh] py-5 md:py-0 order-last md:order-first">
              ...
              >
                ...
                {Project_tag.split(",").map((tag, index) => {
                  return (
                    <span
                      className={`rounded-full border py-1 px-3 border-[${Project_Color}] text-[${Project_Color}] font-black`}
                      key={index}
                    >
                      {tag}
                    </span>
        ...
        return index % 2 === 0 ? (
          <div className="flex flex-col md:flex-row md:justify-center md:items-start   ">
            <div className="basis-full md:basis-1/2 md:border-r-2 md:border-[#1788ae]   h-[100vh] md:h-[100vh] flex justify-center md:justify-start items-center  relative  md:px-24 py-20 md:py-0  ">
              ...
              ></div>
              <div
                className={` hidden md:block absolute   top-50  right-[1%] w-[20vw]  border border-[${Project_Color}] `} data-aos="zoom-in"
                data-aos-offset="0"
                data-aos-delay="1200"
                data-aos-duration="300"
                data-aos-easing="ease-in-sine"
              ...
              >
                <div
                  className={`nameapp absolute  border text-center  w-[60vw] md:w-[18vw] top-[105%] md:top-[0%]  left-[18vw] md:left-[1.5em]   rounded-lg bg-[${Project_Color}] text-white transition  ease-in-out duration-300 font-family-['Nunito', sans-serif ] font-bold  px-4 py-2 `}  data-aos="fade-left"
                  data-aos-offset="0"
                  data-aos-delay="100"
                  data-aos-duration="1200"
                  data-aos-easing="ease-in-sine"
                ...
                <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[70vh] md:h-[70vh] w-[300px] z-[9999] " data-aos="fade-left"
                  data-aos-offset="0"
                  data-aos-delay="50"
                  data-aos-duration="1200"
                  data-aos-easing="ease-in-sine"
                  ...
                  <div className="rounded-[2rem] overflow-hidden  w-full h-[fit-content] bg-white dark:bg-gray-800">
                    <img
                      src={Project_img}
                      className="dark:hidden h-[65vh] md:h-[65vh] w-full rounded-[2.5rem] "
                      alt=""
                      loading="lazy"
                    />
                  </div>
            ...
            <div className="basis-full md:basis-1/2   h-[50vh] md:h-[100vh] flex flex-col justify-center  relative   px-4 md:px-24 py-5 md:py-0 ">
              ...
              <p className="text-base  font-family-['Nunito', sans-serif ] text-justify  mb-3 md:mb-6 text-[#585858] font-normal" 
              data-aos="fade-left"
              data-aos-offset="0"
              data-aos-delay="50"
              data-aos-duration="1200"
              ...
              <div className=" text-white flex flex-wrap gap-2  text-[0.8rem] font-family-['Nunito', sans-serif ]" data-aos="fade-left"
                data-aos-offset="0"
                data-aos-delay="50"
                data-aos-duration="1200"
                data-aos-easing="ease-in-sine"
          ...
          <div className="flex flex-col md:flex-row md:justify-center md:items-start   ">
            <div className="basis-full md:basis-1/2 md:border-r-2 md:border-[#1788ae]   h-[50vh] md:h-[100vh] flex flex-col justify-center  relative   px-4 md:px-24 py-5 md:py-0 order-last md:order-first">
              ...
              <p className="text-base  font-family-['Nunito', sans-serif ] text-justify  mb-3 md:mb-6 text-[#585858] font-normal"  data-aos="fade-right"
              data-aos-offset="0"
              data-aos-delay="50"
              data-aos-duration="1200"
              data-aos-easing="ease-in-sine"
              ...
              <div className=" text-white flex flex-wrap gap-2  text-[0.8rem] font-family-['Nunito', sans-serif ]" data-aos="fade-right"
                data-aos-offset="0"
                data-aos-delay="50"
                data-aos-duration="1200"
                data-aos-easing="ease-in-sine"
            ...
            <div className="basis-full md:basis-1/2   h-[100vh] md:h-[100vh] flex justify-center md:justify-end items-center  relative  md:px-24 py-20 md:py-0">
              ...
              ></div>
              <div
                className={`hidden md:block absolute   top-[50%]  left-[1%] w-[25vw]  border border-[${Project_Color}] `} data-aos="zoom-in"
                data-aos-offset="0"
                data-aos-delay="1200"
                data-aos-duration="300"
                data-aos-easing="ease-in-sine"
              ...
              >
                ...
                <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[70vh] md:h-[70vh] w-[300px] z-[9999] " data-aos="fade-right"
                  data-aos-offset="0"
                  data-aos-delay="50"
                  data-aos-duration="1200"
                  data-aos-easing="ease-in-sine"
