...
const AddProjects = () => {
  ...
  const addProject = async()=>{
    ...
    const productRef = collection(fireDb, "projects");
        try {
          await addDoc(productRef, project);
        ...
        <div>
          ...
          >
            ...
            <div className="flex gap-5  mb-5 md:mb-3">
              ...
              <input type="color" className="rounded px-1 cursor-pointer" name="Project_Color" id="Project_Color" value={project.Project_Color}
                  onChange={(e) => {
                    handleChange(e);
                  }}/>
              <span htmlFor="Project_Color " className="ms-5 hover:text-[#1788ae] hidden md:inline-block">
                Theme Color
              </span>
